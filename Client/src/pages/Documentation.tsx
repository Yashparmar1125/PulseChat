      ...
      <main className="flex-1 py-24 sm:py-32 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          ...
          <p className="text-xl text-pulse-black/70 dark:text-pulse-black/80 leading-relaxed">
            This page is ready to be customized with API documentation, guides, and tutorials.
          </p>
          <p className="text-pulse-black/60 dark:text-pulse-black/70">
            Prompt the user to continue building out this page if they'd like to add developer documentation, API references, or how-to guides.
          </p>
          <Button
            onClick={() => navigate("/")}
            variant="outline"
